...
#'   \item{\code{fitted}}{Fitted response value. It is a \code{n}-by-\code{nlam} matrix, with each column represending a fitted response vector for a value of lambda.}
